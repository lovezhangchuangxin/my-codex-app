...
export function Header() {
  ...
  return (
    <>
      <header className="sticky top-0 z-30 flex h-14 items-center justify-between border-b border-white/6 bg-card px-4 lg:h-[60px] lg:px-6">
        ...
        <div className="hidden flex-1 items-center justify-center px-8 lg:flex">
          <div className="w-full max-w-md rounded-lg border border-white/6 bg-background/50 px-3 py-1.5 font-mono text-sm text-muted-foreground">
            Search...
          </div>
        </div>

        <div className="flex items-center gap-1">
          <NotificationBell onClick={() => { setRequestSheetOpen((v) => !v); }} />
          <Button
            className="relative"
