        ...
        <div className="flex min-h-0 flex-1 flex-col">
          ...
          <div className="border-t border-subtle/6 p-4">
            ...
            >
              ...
              {submitting
                ? t('project.import.submitting')
                : t('project.import.submit')}
            </Button>
          </div>
        </div>
      </SheetContent>
