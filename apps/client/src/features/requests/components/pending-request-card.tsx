...
import {
  ...
  PendingRequestIcon,
} from '@/features/requests/components/pending-request-actions';
import {
  PendingRequestBody,
  PendingRequestTitle,
} from '@/features/requests/components/pending-request-body';
            ...
            <div className="space-y-1">
              ...
              {showThreadContext ? (
                <p className="text-sm text-muted-foreground">
                  {t('request.threadLabel', {
                    title: buildThreadTitle(thread, t),
                  })}
                </p>
              ) : null}
            </div>
